...
class Cfg extends CI_Model {
    public function get_data($kode=''){
        ...
        if($cfg){
	        	$data = array('sistem'=> $cfg->sistem, 'app_status'=> $cfg->app_status, 'antri'=> $cfg->antri, 'qr_code'=> $cfg->qr_code, 'bar_code'=> $cfg->bar_code, 'desa'=> $cfg->desa, 'kec'=> $cfg->kec, 'kab_kota'=> $cfg->kabkot,'dig_no_und'=> $cfg->dig_no_und);
	     }else{
