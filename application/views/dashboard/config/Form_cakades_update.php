...
<div class="panel panel-inverse panel_modal">
	...
	<div class="panel-body p-b-0">
		<form id="form_update_cakades" autocomplete="off" action="<?php echo base_url('setting/update_cakades');?>" method="POST">
			<div class="form-row">
				<div class="col-md-8">
			...
			<div class="form-row m-t-10 m-b-10">
				<div class="col">
					<button type="button" class="btn btn-danger btn-md" onclick="remove_cakades(<?php echo $result->id;?>)">Hapus</button>
